...
<html>
    ...
    <body>
        ...
        <jsp:include page="/root/display/management/header.jsp"></jsp:include>
            <div class="container mt-4">
                ...
                <p class="error-message">${ErrDate}</p>
            </c:if>
            <c:if test="${not empty CreateForm}">
                <p class="success-message">${CreateForm}</p>
            </c:if>
        </div>
